...
const copy: Record<Props["locale"], { title: string; description: string }> = {
  de: {
    title: "Verbraucherinformationen (Fern‑Finanzdienstleistungs‑Gesetz)",
    description:
      "Auszug zur Bestätigung des Erhalts von Verbraucherinformationen gemäß Fern‑Finanzdienstleistungs‑Gesetz (Depotantrag).",
  },
  en: {
    title: "Consumer Information (Distance Financial Services Act)",
    description:
      "Excerpt confirming receipt of consumer information under the Distance Financial Services Act (depot application).",
  },
}

export function ConsumerInformationFfgPageHero({ locale }: Props) {
  const c = copy[locale]
