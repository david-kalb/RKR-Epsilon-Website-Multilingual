...
const copy: Record<Props["locale"], { title: string; description: string }> = {
  de: {
    title: "Öffnungs- und Annahmezeiten",
    description: "Auszug zur Bestätigung des Erhalts von Informationen über Öffnungs- und Annahmezeiten (Depotantrag).",
  },
  en: {
    title: "Opening & Acceptance Times",
    description: "Excerpt confirming receipt of information about opening and acceptance times (depot application).",
  },
}

export function OpeningAndAcceptanceTimesPageHero({ locale }: Props) {
  const c = copy[locale]
